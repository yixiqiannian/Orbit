...
export const taskApi = {
  ...
  create(data: { title: string; type: string; description?: string; priority?: number; due_date?: string }) {
    return api.post<any, Task>('/api/tasks', data)
  },
  update(id: number, data: { title?: string; status?: string; priority?: number }) {
